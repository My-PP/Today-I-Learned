...
На то есть столько же причин, сколько команд в Git. Командная строка - очень мощный инструмент, как и IDE, но они хороши каждый по-своему. Когда нужно использовать Git на полную катушку, командная строка вне конкуренции. Помните об автодополнении, такая функция есть и в Bash, и в Zsh, и в Powershell. Автодополнение избавляет вас от необходимости запоминать полные команды.
...
- [Как фильтровать Git логи](#10)
  - [получение всех коммитов](#10-1)
  - [получение последних n коммитов](#10-2)
  - [получение коммитов с определенной даты](#10-3)
  - [получение коммитов до определенной даты](#10-4)
  - [получение коммитов по автору](#10-5)
  - [получение коммитов между двумя SHAs](#10-6)
  - [получение коммитов, относящихся к файлу](#10-7)
  - [получение коммитов с использованием выражения](#10-8)
