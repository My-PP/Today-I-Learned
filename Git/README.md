...
- [Установка в Windows](#установка-вwindows)
- [Установка в Linux](#установка-вlinux)
- [Установка на macOS](#установка-наmacos)
...
- [Что такое GitHub и чем он отличается от Git?](../Git/GitHub/README.md#что-такое-github-в-чём-его-функции-и-чем-он-отличается-от-git)
- [GitLab – набирающая популярность альтернатива GitHub](/Git/GitLab/README.md#gitlab-–-набирающая-популярность-альтернатива-github)
- [Bitbucket – еще один популярный инструмент](/Git/Bitbucket/README.md#bitbucket-–-еще-один-популярный-инструмент)
...
- [Основная шпаргалка по командам Git](#основная-шпаргалка-по-командам-git)
  - [по основным командам](#по-основным-командам)
  - [по ветвлению и слиянию](#по-ветвлению-и-слиянию)
  - [по совместной работе и обновлению проектов](#по-совместной-работе-и-обновлению-проектов)
  - [по осмотру и сравнению](#по-осмотру-и-сравнению)
  - [по отладке](#по-отладке)
- [Расширенная шпаргалка](#расширенная-шпаргалка)
  - [восстановление накопленных изменений](#восстановление-накопленных-изменений)
  - [восстановление удалённого тега](#восстановление-удалённого-тега)
  - [восстановление удалённого файла](#восстановление-удалённого-файла)
  - [восстановление удалённой ветки](#восстановление-удалённой-ветки)
  - [изменение сообщения коммита перед его отправкой](#изменение-сообщения-коммита-перед-его-отправкой)
  - [изменение сообщения коммита после его отправки](#изменение-сообщения-коммита-после-его-отправки)
  - [коммит в неправильную ветку](#коммит-в-неправильную-ветку)
  - [откат к конкретному коммиту в истории](#откат-к-конкретному-коммиту-в-истории)
  - [отмена коммита до публикации изменений](#отмена-коммита-до-публикации-изменений)
  - [отмена коммита после отправки его в master-репозиторий](#отмена-коммита-после-отправки-его-в-master-репозиторий)
  - [отмена локальных изменений файлов](#отмена-локальных-изменений-файлов)
  - [отображение всех коммитов одного файла](#отображение-всех-коммитов-одного-файла)
  - [переименование локальной и удалённой ветки](#переименование-локальной-и-удалённой-ветки)
  - [переименование тега](#переименование-тега)
  - [перестать отслеживать существующие файлы](#перестать-отслеживать-существующие-файлы)
  - [подготовка удалённых файлов](#подготовка-удалённых-файлов)
  - [просмотр всех неотправленных коммитов](#просмотр-всех-неотправленных-коммитов)
  - [просмотр старой ревизии файла](#просмотр-старой-ревизии-файла)
  - [публикация локальной ветки для удалённого редактирования](#публикация-локальной-ветки-для-удалённого-редактирования)
  - [сброс локальной ветки до состояния удалённой](#сброс-локальной-ветки-до-состояния-удалённой)
  - [синхронизировать ветку с master-репозиторием](#синхронизировать-ветку-с-master-репозиторием)
  - [слияние локальных изменений с другой веткой](#слияние-локальных-изменений-с-другой-веткой)
  - [создание новой ветки с изменениями текущей](#создание-новой-ветки-с-изменениями-текущей)
  - [убрать файл из буфера](#убрать-файл-из-буфера)
  - [удаление внешней ветки](#удаление-внешней-ветки)
  - [удаление неотслеживаемых файлов и папок](#удаление-неотслеживаемых-файлов-и-папок)
  - [удаление старых веток, стёртых из внешнего репозитория](#удаление-старых-веток-стёртых-из-внешнего-репозитория)
- [Как правильно составлять описания коммитов и почему это важно](#как-правильно-составлять-описания-коммитов-и-почему-это-важно)
  - [Семь правил хорошего описания коммита](#семь-правил-хорошего-описания-коммита)
- [Как фильтровать Git логи](#как-фильтровать-git-логи)
  - [получение всех коммитов](#получение-всех-коммитов)
  - [получение последних n коммитов](#получение-последних-n-коммитов)
  - [получение коммитов с определенной даты](#получение-коммитов-с-определенной-даты)
  - [получение коммитов до определенной даты](#получение-коммитов-до-определенной-даты)
  - [получение коммитов по автору](#получение-коммитов-по-автору)
  - [получение коммитов между двумя SHAs](#получение-коммитов-между-двумя-shas)
  - [получение коммитов, относящихся к файлу](#получение-коммитов-относящихся-к-файлу)
  - [получение коммитов с использованием выражения](#получение-коммитов-с-использованием-выражения)
...
📖 [Система контроля версий Git](#оглавление) | [Today-I-Learned](/README.md#til-today-i-learnedсегодня-я-узнал-вот-что)
